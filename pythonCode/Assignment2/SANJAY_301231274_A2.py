...
class TempSensor:
    ...
    def __init__(self, maxTemp=100, minTemp=0, base=0.5, spread=0.2, delta= 0.005, minCycle=2, maxCycle=10) -> None:        
...
y = [TempSensor1.generateTemp() for _ in range(number_of_values)]
#x = [x for x in range(number_of_values)]


plt.plot(y)

#Labels
plt.title('Graph of Temperature Vs Time for a Temperature Sensor')
